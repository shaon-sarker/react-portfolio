        ...
        <section class="banner-area">
            <div class="container">
                <div class="row fullscreen align-items-center justify-content-between">
                    ...
                    <a href="https://pdfhost.io/v/D.2Ar1Usj_shaon_cv.pdf" target="__blank"
                        class="primary-btn text-uppercase">Download CV</a>
                    </div>
                    <div class="col-lg-6 col-md-6 banner-right d-flex align-self-end">
                    <img class="img-fluid" src="assets/images/about.png" alt="about me"/>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="home-about-area pt-120">
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    ...
                    <img class="img-fluid" src="assets/images/about/portfolio.svg" alt=""/>
                    </div>
                    ...
                    <a href="https://pdfhost.io/v/D.2Ar1Usj_shaon_cv.pdf" target="__blank"
                        class="primary-btn text-uppercase">View Full Details</a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="title text-center">
                        ...
                        <p>Here are some demos, click on the <a href="https://github.com/shaon-sarker"><b>Github</b>
                            </a>to see
                            the whole.
                        </p>
                    </div>
                ...
                <div class="filters">
                    <ul>
                    <li class="active" data-filter="*" onClick={()=>setPortfolio(portfolio)}>All</li>
                    <li data-filter=".vector" onClick={()=>filterItem("WebDesign")}>Website Design</li>
                    <li data-filter=".raster" onClick={()=>filterItem("Javascript")}>Javascript Work</li>
                    <li data-filter=".ui" onClick={()=>filterItem("wordpress")}>Wordpress</li>
                    <li data-filter=".printing" onClick={()=>filterItem("webdevelopment")}>Web Development</li>
                    </ul>
                </div>
                                ...
                                <div class="single-portfolio col-sm-4 all vector" key={id}>
                                    <div class="relative">
                                        <div class="thumb">
                                            ...
                                            <img class="image img-fluid" src={image} alt={altname}/>
                                        </div>
                                    </div>
                                    <div class="p-inner">
                                        <h4>{name}</h4>
                ...
                <div class="row">
                    <div class="active-testimonial">
                        {testimonials.map((testimonial)=>{
                            const {id,image,heading,describe,title,altname} = testimonial;
                            return(
