            ...
            <div class="col-lg-2 col-md-6 col-sm-6 social-widget">
               <div class="single-footer-widget">
                  ...
                  <div class="footer-social d-flex align-items-center">
                     ...
                     <a href="https://twitter.com/Shaon23081175" target="__blank"><i class="fa fa-twitter"></i></a>
                     <a href="https://dribbble.com/Shaon_54" target="__blank"><i class="fa fa-dribbble"></i></a>
                     <a href="https://www.linkedin.com/in/shaon-sarker/" target="__blank"><i
                           class="fa fa-linkedin"></i></a>
                     <a href="https://github.com/shaon-sarker" target="__blank"><i class="fa fa-github"></i></a>
                  </div>
               </div>
            </div>
         </div>
